...
core = (
    '_atom_site_adp_type', '_atom_site_aniso_B_11',
    '_atom_site_aniso_B_12', '_atom_site_aniso_B_13',
    '_atom_site_aniso_B_22', '_atom_site_aniso_B_23',
    '_atom_site_aniso_B_33', '_atom_site_aniso_label',
    '_atom_site_aniso_ratio',
    '_atom_site_aniso_type_symbol',
    '_atom_site_aniso_U_11', '_atom_site_aniso_U_12',
    '_atom_site_aniso_U_13', '_atom_site_aniso_U_22',
    '_atom_site_aniso_U_23', '_atom_site_aniso_U_33',
    '_atom_site_attached_hydrogens',
    '_atom_site_B_equiv_geom_mean',
    '_atom_site_B_iso_or_equiv',
    '_atom_site_calc_attached_atom',
    '_atom_site_calc_flag', '_atom_site_Cartn_x',
    '_atom_site_Cartn_y',
    '_atom_site_Cartn_z',
    ...
    '_atom_site_disorder_group', '_atom_site_fract_x',
    '_atom_site_fract_y',
    ...
    '_atom_type_symbol', '_audit_block_code',
    '_audit_block_doi', '_audit_creation_date',
    '_audit_creation_method',
    '_audit_update_record', '_audit_author_address',
    '_audit_author_name',
    ...
    '_cell_formula_units_Z', '_cell_length_a',
    '_cell_length_b',
    '_cell_length_c', '_cell_measurement_pressure',
    ...
    '_cell_special_details', '_cell_volume',
    ...
    '_citation_abstract', '_citation_abstract_id_CAS',
    ...
    '_citation_country', '_citation_database_id_CSD',
    '_citation_database_id_Medline', '_citation_doi',
    '_citation_id', '_citation_journal_abbrev',
    '_citation_journal_full',
    '_citation_journal_id_ASTM',
    '_citation_journal_id_CSD',
    '_citation_journal_id_ISSN',
    '_citation_journal_issue',
    '_citation_journal_volume', '_citation_language',
    '_citation_page_first',
    '_citation_page_last', '_citation_publisher',
    '_citation_special_details', '_citation_title',
    '_citation_year',
    ...
    '_database_code_CAS', '_database_code_COD',
    '_database_code_CSD',
    '_database_code_ICSD', '_database_code_MDF',
    '_database_code_NBS', '_database_code_PDB',
    '_database_code_PDF',
    '_database_code_depnum_ccdc_archive',
    '_database_code_depnum_ccdc_fiz',
    '_database_code_depnum_ccdc_journal',
    '_database_CSD_history', '_database_dataset_doi',
    '_database_journal_ASTM', '_database_journal_CSD',
    ...
    '_diffrn_attenuator_scale', '_diffrn_detector',
    ...
    '_diffrn_radiation_source', '_diffrn_source',
    '_diffrn_source_current',
    '_diffrn_source_details',
    '_diffrn_source_power', '_diffrn_source_size',
    '_diffrn_source_take-off_angle',
    '_diffrn_source_target',
    '_diffrn_source_type', '_diffrn_source_voltage',
    ...
    '_exptl_crystal_F_000', '_exptl_crystal_id',
    ...
    '_geom_special_details', '_geom_angle',
    ...
    '_geom_bond_distance', '_geom_bond_multiplicity',
    ...
    '_geom_hbond_site_symmetry_A', '_geom_torsion',
    ...
    '_journal_coden_ASTM', '_journal_coden_Cambridge',
    '_journal_coeditor_address',
    '_journal_coeditor_code',
    '_journal_coeditor_email',
    '_journal_coeditor_fax', '_journal_coeditor_name',
    ...
    '_journal_issue', '_journal_language',
    '_journal_name_full', '_journal_page_first',
    '_journal_page_last',
    '_journal_paper_category', '_journal_paper_doi',
    ...
    '_journal_volume', '_journal_year',
    '_journal_index_subterm', '_journal_index_term',
    '_journal_index_type',
    ...
    '_publ_requested_journal', '_publ_section_title',
    '_publ_section_title_footnote',
    '_publ_section_synopsis',
    '_publ_section_abstract', '_publ_section_comment',
    ...
    '_publ_author_address', '_publ_author_email',
    '_publ_author_footnote', '_publ_author_id_iucr',
    '_publ_author_id_orcid', '_publ_author_name',
    '_publ_body_contents', '_publ_body_element',
    '_publ_body_format',
    '_publ_body_label', '_publ_body_title',
    ...
    '_refine_ls_d_res_high', '_refine_ls_d_res_low',
    ...
    '_refine_ls_class_wR_factor_all', '_refln_A_calc',
    '_refln_A_meas',
    '_refln_B_calc', '_refln_B_meas',
    '_refln_class_code', '_refln_crystal_id',
    '_refln_d_spacing', '_refln_F_calc',
    '_refln_F_meas', '_refln_F_sigma',
    '_refln_F_squared_calc', '_refln_F_squared_meas',
    '_refln_F_squared_sigma',
    '_refln_include_status', '_refln_index_h',
    ...
    '_refln_phase_calc', '_refln_phase_meas',
    '_refln_refinement_status',
    '_refln_scale_group_code',
    '_refln_sint/lambda', '_refln_symmetry_epsilon',
    ...
    '_reflns_limit_h_max', '_reflns_limit_h_min',
    '_reflns_limit_k_max', '_reflns_limit_k_min',
    '_reflns_limit_l_max', '_reflns_limit_l_min',
    '_reflns_number_gt',
    '_reflns_number_observed', '_reflns_number_total',
    '_reflns_observed_criterion',
    '_reflns_special_details',
    '_reflns_threshold_expression',
    '_reflns_class_code', '_reflns_class_d_res_high',
    ...
    '_space_group_crystal_system', '_space_group_id',
    '_space_group_IT_number',
    '_space_group_name_H-M_alt',
    '_space_group_name_Hall', '_space_group_symop_id',
    ...
    '_valence_param_B',
    '_valence_param_details', '_valence_param_id',
    '_valence_param_ref_id', '_valence_param_Ro',
    '_valence_ref_id',
