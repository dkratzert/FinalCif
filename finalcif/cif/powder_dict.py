powder_dict = {'_pd_block_[pd]': '<pre> _pd_block_id is used to assign a unique ID code to a data block.\n'
 ...
 '_pd_block_diffractogram_id': '<pre> A block ID code (see _pd_block_id) that identifies\n'
 ...
 '_pd_calc_[pd]': '<pre> This section is used for storing a computed diffractogram trace.\n'
 ...
 '_pd_calc_intensity_net': '<pre> Intensity values for a computed diffractogram at\n'
 ...
 '_pd_calc_intensity_total': '<pre> Intensity values for a computed diffractogram at\n'
                             ' each angle setting. Values should be computed at the\n'
                             ' same locations as the processed diffractogram, and thus\n'
                             ' the numbers of points will be defined by\n'
                             ' _pd_proc_number_of_points and point positions may\n'
                             ...
                             ' should be looped with either _pd_proc_intensity_net,\n'
                             ' _pd_meas_counts_ or _pd_meas_intensity_.</pre>',
 '_pd_calc_method': '<pre> A description of the method used for the calculation of\n'
 ...
 '_pd_calc_point_id': '<pre> Arbitrary label identifying a calculated data point. Used to\n'
 ...
 '_pd_calib_2theta_off_max': '<pre> _pd_calib_2theta_offset defines an offset angle (in degrees)\n'
 ...
 '_pd_calib_2theta_off_min': '<pre> _pd_calib_2theta_offset defines an offset angle (in degrees)\n'
                             ' used to calibrate 2\\q (as defined in _pd_meas_2theta_).\n'
                             ' Calibration is done by adding the offset:\n'
                             '\n'
                             '      2\\q~calibrated~ = 2\\q~measured~ + 2\\q~offset~\n'
                             ...
                             ' range where the offset is applicable can be specified using\n'
                             ' _pd_calib_2theta_off_min and _pd_calib_2theta_off_max.</pre>',
 '_pd_calib_2theta_off_point': '<pre> _pd_calib_2theta_offset defines an offset angle (in '
                               'degrees)\n'
                               ' used to calibrate 2\\q (as defined in _pd_meas_2theta_).\n'
                               ' Calibration is done by adding the offset:\n'
                               '\n'
                               ...
                               ' range where the offset is applicable can be specified using\n'
                               ' _pd_calib_2theta_off_min and _pd_calib_2theta_off_max.</pre>',
 '_pd_calib_2theta_offset': '<pre> _pd_calib_2theta_offset defines an offset angle (in degrees)\n'
                            ' used to calibrate 2\\q (as defined in _pd_meas_2theta_).\n'
                            ' Calibration is done by adding the offset:\n'
                            '\n'
                            '      2\\q~calibrated~ = 2\\q~measured~ + 2\\q~offset~\n'
                            ...
                            ' range where the offset is applicable can be specified using\n'
                            ' _pd_calib_2theta_off_min and _pd_calib_2theta_off_max.</pre>',
 '_pd_calib_[pd]': '<pre> This section defines the parameters used for the calibration \n'
                   ...
                   '    ;</pre>',
 '_pd_calib_detector_id': '<pre> A code which identifies the detector or channel number in a\n'
 ...
 '_pd_calib_detector_response': '<pre> A value that indicates the relative sensitivity of each\n'
 ...
 '_pd_calib_std_external_block_id': '<pre> Identifies the data set used as an external standard '
                                    'for\n'
 ...
 '_pd_calib_std_external_name': '<pre> Identifies the data set used as an external standard for\n'
                                ' the diffraction angle or the intensity calibrations.\n'
                                ' *_name specifies the name of the material and\n'
                                ' *_id the _pd_block_id for the CIF containing calibration\n'
                                ' measurements. If more than one data set is used for\n'
                                ' calibration, these fields may be looped.</pre>',
 '_pd_calib_std_internal_mass_%': '<pre> Per cent presence of the internal standard specified by '
                                  'the\n'
                                  ' data item _pd_calib_std_internal_name expressed as 100 times\n'
                                  ' the ratio of the amount of standard added to the original\n'
                                  ' sample mass.</pre>',
 '_pd_calib_std_internal_name': '<pre> Identity of material(s) used as an internal intensity '
                                'standard.\n'
                                '\n'
                                'Example:\n'
                                'NIST 640a Silicon standard\n'
                                'Al2O3</pre>',
 '_pd_calibration_conversion_eqn': '<pre> The calibration function for converting a channel '
                                   'number\n'
                                   ...
                                   ')</pre>',
 '_pd_calibration_special_details': '<pre> Description of how the instrument was\n'
                                    ...
                                    ' items.</pre>',
 '_pd_char_[pd]': '<pre>   This section contains experimental (non-diffraction) information\n'
                  '    relevant to the chemical and physical nature of the material.</pre>',
 '_pd_char_atten_coef_mu_calc': '<pre> The observed and calculated linear attenuation '
                                'coefficient,\n'
                                ...
                                ' not unity.</pre>',
 '_pd_char_atten_coef_mu_obs': '<pre> The observed and calculated linear attenuation coefficient,\n'
                               ' \\m, in units of inverse millimetres. Note that this quantity\n'
                               ' is sometimes referred to as the mass absorption coefficient;\n'
                               ' however, this term accounts for other potentially significant\n'
                               ' losses of incident radiation, for example incoherent\n'
                               ...
                               ' _exptl_absorpt_coefficient_mu if the packing density is\n'
                               ' not unity.</pre>',
 '_pd_char_colour': '<pre> The colour of the material used for the measurement.\n'
                    ...
                    'brownish_red\n'
                    'yellow_metallic</pre>',
 '_pd_char_particle_morphology': '<pre> A description of the sample morphology and estimates for\n'
 ...
 '_pd_char_special_details': '<pre> Additional characterization information relevant to the '
                             'sample\n'
                             ' or documentation of non-routine processing steps used\n'
                             ' for characterization.</pre>',
 '_pd_data_[pd]': '<pre> The PD_DATA category contains raw, processed and calculated\n'
                  ...
                  '            4a  21.9  90\n'
                  '</pre>',
 '_pd_data_point_id': '<pre> Arbitrary label identifying an entry in the table of\n'
                      ' diffractogram intensity values.</pre>',
 '_pd_instr_2theta_monochr_post': '<pre> The 2\\q angle for a pre-specimen or post-specimen\n'
                                  ' monochromator (see _pd_instr_monochr_pre_spec and\n'
                                  ' _pd_instr_monochr_post_spec).</pre>',
 '_pd_instr_2theta_monochr_pre': '<pre> The 2\\q angle for a pre-specimen or post-specimen\n'
                                 ' monochromator (see _pd_instr_monochr_pre_spec and\n'
                                 ' _pd_instr_monochr_post_spec).</pre>',
 '_pd_instr_[pd]': '<pre> This section contains information relevant to the instrument\n'
 ...
 '_pd_instr_beam_size_ax': '<pre> Axial and equatorial dimensions of the radiation beam\n'
 ...
 '_pd_instr_beam_size_eq': '<pre> Axial and equatorial dimensions of the radiation beam\n'
                           ' at the specimen position (in millimetres).\n'
                           ' The perpendicular to the plane containing the incident\n'
                           ' and scattered beam is the axial (*_ax) direction.</pre>',
 '_pd_instr_cons_illum_flag': "<pre> Use 'yes' for instruments where the divergence slit is\n"
 ...
 '_pd_instr_dist_anal/detc': '<pre> Specifies distances in millimetres for the instrument '
                             'geometry:\n'
 ...
 '_pd_instr_dist_mono/spec': '<pre> Specifies distances in millimetres for the instrument '
                             'geometry:\n'
                             '   *_src/mono, the distance from the radiation source\n'
                             '       to the monochromator;\n'
                             '   *_mono/spec, the distance from the monochromator to\n'
                             ...
                             ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                             ' if there is no analyser in use.</pre>',
 '_pd_instr_dist_spec/anal': '<pre> Specifies distances in millimetres for the instrument '
                             'geometry:\n'
                             '   *_src/mono, the distance from the radiation source\n'
                             '       to the monochromator;\n'
                             '   *_mono/spec, the distance from the monochromator to\n'
                             ...
                             ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                             ' if there is no analyser in use.</pre>',
 '_pd_instr_dist_spec/detc': '<pre> Specifies distances in millimetres for the instrument '
                             'geometry:\n'
                             '   *_src/mono, the distance from the radiation source\n'
                             '       to the monochromator;\n'
                             '   *_mono/spec, the distance from the monochromator to\n'
                             ...
                             ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                             ' if there is no analyser in use.</pre>',
 '_pd_instr_dist_src/mono': '<pre> Specifies distances in millimetres for the instrument '
                            'geometry:\n'
                            '   *_src/mono, the distance from the radiation source\n'
                            '       to the monochromator;\n'
                            '   *_mono/spec, the distance from the monochromator to\n'
                            ...
                            ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                            ' if there is no analyser in use.</pre>',
 '_pd_instr_dist_src/spec': '<pre> Specifies distances in millimetres for the instrument '
                            'geometry:\n'
                            '   *_src/mono, the distance from the radiation source\n'
                            '       to the monochromator;\n'
                            '   *_mono/spec, the distance from the monochromator to\n'
                            ...
                            ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                            ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_ax_anal/detc': '<pre> Describes collimation in the axial direction\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_ax_mono/spec': '<pre> Describes collimation in the axial direction\n'
                                ' (perpendicular to the plane containing the incident\n'
                                ' and diffracted beams) for the instrument.\n'
                                ' Values are the maximum divergence angles in\n'
                                ' degrees, as limited by slits or beamline optics\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_ax_spec/anal': '<pre> Describes collimation in the axial direction\n'
                                ' (perpendicular to the plane containing the incident\n'
                                ' and diffracted beams) for the instrument.\n'
                                ' Values are the maximum divergence angles in\n'
                                ' degrees, as limited by slits or beamline optics\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_ax_spec/detc': '<pre> Describes collimation in the axial direction\n'
                                ' (perpendicular to the plane containing the incident\n'
                                ' and diffracted beams) for the instrument.\n'
                                ' Values are the maximum divergence angles in\n'
                                ' degrees, as limited by slits or beamline optics\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_ax_src/mono': '<pre> Describes collimation in the axial direction\n'
                               ' (perpendicular to the plane containing the incident\n'
                               ' and diffracted beams) for the instrument.\n'
                               ' Values are the maximum divergence angles in\n'
                               ' degrees, as limited by slits or beamline optics\n'
                               ...
                               ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                               ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_ax_src/spec': '<pre> Describes collimation in the axial direction\n'
                               ' (perpendicular to the plane containing the incident\n'
                               ' and diffracted beams) for the instrument.\n'
                               ' Values are the maximum divergence angles in\n'
                               ' degrees, as limited by slits or beamline optics\n'
                               ...
                               ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                               ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_eq_anal/detc': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_eq_mono/spec': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                ' containing the incident and diffracted beams) for\n'
                                ' the instrument. Values are the maximum divergence angles in\n'
                                ' degrees, as limited by slits or beamline optics\n'
                                ' other than Soller slits (see _pd_instr_soller_eq_):\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_eq_spec/anal': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                ' containing the incident and diffracted beams) for\n'
                                ' the instrument. Values are the maximum divergence angles in\n'
                                ' degrees, as limited by slits or beamline optics\n'
                                ' other than Soller slits (see _pd_instr_soller_eq_):\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_eq_spec/detc': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                ' containing the incident and diffracted beams) for\n'
                                ' the instrument. Values are the maximum divergence angles in\n'
                                ' degrees, as limited by slits or beamline optics\n'
                                ' other than Soller slits (see _pd_instr_soller_eq_):\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_eq_src/mono': '<pre> Describes collimation in the equatorial plane (the plane\n'
                               ' containing the incident and diffracted beams) for\n'
                               ' the instrument. Values are the maximum divergence angles in\n'
                               ' degrees, as limited by slits or beamline optics\n'
                               ' other than Soller slits (see _pd_instr_soller_eq_):\n'
                               ...
                               ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                               ' if there is no analyser in use.</pre>',
 '_pd_instr_divg_eq_src/spec': '<pre> Describes collimation in the equatorial plane (the plane\n'
                               ' containing the incident and diffracted beams) for\n'
                               ' the instrument. Values are the maximum divergence angles in\n'
                               ' degrees, as limited by slits or beamline optics\n'
                               ' other than Soller slits (see _pd_instr_soller_eq_):\n'
                               ...
                               ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                               ' if there is no analyser in use.</pre>',
 '_pd_instr_geometry': '<pre> A description of the diffractometer type or geometry.\n'
                       '\n'
                       'Example:\n'
                       'Bragg-Brentano\n'
                       'Guinier\n'
 ...
 '_pd_instr_location': '<pre> The name and location of the instrument where measurements\n'
 ...
 '_pd_instr_monochr_post_spec': '<pre> Indicates the method used to obtain monochromatic '
                                'radiation.\n'
 ...
 '_pd_instr_monochr_pre_spec': '<pre> Indicates the method used to obtain monochromatic '
                               'radiation.\n'
                               ' Use _pd_instr_monochr_pre_spec to describe the primary beam\n'
                               ' monochromator (pre-specimen monochromation). Use\n'
                               ' _pd_instr_monochr_post_spec to specify the\n'
                               ...
                               'equatorial mounted graphite (0001)\n'
                               'Si (111), antiparallel</pre>',
 '_pd_instr_slit_ax_anal/detc': '<pre> Describes collimation in the axial direction\n'
                                ' (perpendicular to the plane containing the incident\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_slit_ax_mono/spec': '<pre> Describes collimation in the axial direction\n'
                                ' (perpendicular to the plane containing the incident\n'
                                ' and diffracted beams) for the instrument as a slit width\n'
                                ' (as opposed to a divergence angle).\n'
                                ' Values are the width of the slit (in millimetres) defining:\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_slit_ax_spec/anal': '<pre> Describes collimation in the axial direction\n'
                                ' (perpendicular to the plane containing the incident\n'
                                ' and diffracted beams) for the instrument as a slit width\n'
                                ' (as opposed to a divergence angle).\n'
                                ' Values are the width of the slit (in millimetres) defining:\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_slit_ax_spec/detc': '<pre> Describes collimation in the axial direction\n'
                                ' (perpendicular to the plane containing the incident\n'
                                ' and diffracted beams) for the instrument as a slit width\n'
                                ' (as opposed to a divergence angle).\n'
                                ' Values are the width of the slit (in millimetres) defining:\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                                ' if there is no analyser in use.</pre>',
 '_pd_instr_slit_ax_src/mono': '<pre> Describes collimation in the axial direction\n'
                               ' (perpendicular to the plane containing the incident\n'
                               ' and diffracted beams) for the instrument as a slit width\n'
                               ' (as opposed to a divergence angle).\n'
                               ' Values are the width of the slit (in millimetres) defining:\n'
                               ...
                               ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                               ' if there is no analyser in use.</pre>',
 '_pd_instr_slit_ax_src/spec': '<pre> Describes collimation in the axial direction\n'
                               ' (perpendicular to the plane containing the incident\n'
                               ' and diffracted beams) for the instrument as a slit width\n'
                               ' (as opposed to a divergence angle).\n'
                               ' Values are the width of the slit (in millimetres) defining:\n'
                               ...
                               ' *_spec/detc is used in place of *_spec/anal and *_anal/detc \n'
                               ' if there is no analyser in use.</pre>',
 '_pd_instr_slit_eq_anal/detc': '<pre> Describes collimation in the equatorial plane (the plane\n'
 ...
 '_pd_instr_slit_eq_mono/spec': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                ' containing the incident and diffracted beams) for the\n'
                                ' instrument as a slit width (as opposed to a divergence angle).\n'
                                ' Values are the width of the slit (in millimetres) defining:\n'
                                '   *_src/mono, collimation between the radiation source\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and \n'
                                ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_slit_eq_spec/anal': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                ' containing the incident and diffracted beams) for the\n'
                                ' instrument as a slit width (as opposed to a divergence angle).\n'
                                ' Values are the width of the slit (in millimetres) defining:\n'
                                '   *_src/mono, collimation between the radiation source\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and \n'
                                ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_slit_eq_spec/detc': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                ' containing the incident and diffracted beams) for the\n'
                                ' instrument as a slit width (as opposed to a divergence angle).\n'
                                ' Values are the width of the slit (in millimetres) defining:\n'
                                '   *_src/mono, collimation between the radiation source\n'
                                ...
                                ' *_spec/detc is used in place of *_spec/anal and \n'
                                ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_slit_eq_src/mono': '<pre> Describes collimation in the equatorial plane (the plane\n'
                               ' containing the incident and diffracted beams) for the\n'
                               ' instrument as a slit width (as opposed to a divergence angle).\n'
                               ' Values are the width of the slit (in millimetres) defining:\n'
                               '   *_src/mono, collimation between the radiation source\n'
                               ...
                               ' *_spec/detc is used in place of *_spec/anal and \n'
                               ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_slit_eq_src/spec': '<pre> Describes collimation in the equatorial plane (the plane\n'
                               ' containing the incident and diffracted beams) for the\n'
                               ' instrument as a slit width (as opposed to a divergence angle).\n'
                               ' Values are the width of the slit (in millimetres) defining:\n'
                               '   *_src/mono, collimation between the radiation source\n'
                               ...
                               ' *_spec/detc is used in place of *_spec/anal and \n'
                               ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_ax_anal/detc': '<pre> Describes collimation in the axial direction\n'
                                  ' (perpendicular to the plane containing the incident\n'
                                  ' and diffracted beams) for the instrument.\n'
                                  ' Values are the maximum divergence angles in\n'
                                  ...
                                  ' *_spec/detc is used in place of *_spec/anal and \n'
                                  ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_ax_mono/spec': '<pre> Describes collimation in the axial direction\n'
                                  ' (perpendicular to the plane containing the incident\n'
                                  ' and diffracted beams) for the instrument.\n'
                                  ' Values are the maximum divergence angles in\n'
                                  ' degrees, as limited by Soller slits located thus:\n'
                                  ...
                                  ' *_spec/detc is used in place of *_spec/anal and \n'
                                  ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_ax_spec/anal': '<pre> Describes collimation in the axial direction\n'
                                  ' (perpendicular to the plane containing the incident\n'
                                  ' and diffracted beams) for the instrument.\n'
                                  ' Values are the maximum divergence angles in\n'
                                  ' degrees, as limited by Soller slits located thus:\n'
                                  ...
                                  ' *_spec/detc is used in place of *_spec/anal and \n'
                                  ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_ax_spec/detc': '<pre> Describes collimation in the axial direction\n'
                                  ' (perpendicular to the plane containing the incident\n'
                                  ' and diffracted beams) for the instrument.\n'
                                  ' Values are the maximum divergence angles in\n'
                                  ' degrees, as limited by Soller slits located thus:\n'
                                  ...
                                  ' *_spec/detc is used in place of *_spec/anal and \n'
                                  ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_ax_src/mono': '<pre> Describes collimation in the axial direction\n'
                                 ' (perpendicular to the plane containing the incident\n'
                                 ' and diffracted beams) for the instrument.\n'
                                 ' Values are the maximum divergence angles in\n'
                                 ' degrees, as limited by Soller slits located thus:\n'
                                 ...
                                 ' *_spec/detc is used in place of *_spec/anal and \n'
                                 ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_ax_src/spec': '<pre> Describes collimation in the axial direction\n'
                                 ' (perpendicular to the plane containing the incident\n'
                                 ' and diffracted beams) for the instrument.\n'
                                 ' Values are the maximum divergence angles in\n'
                                 ' degrees, as limited by Soller slits located thus:\n'
                                 ...
                                 ' *_spec/detc is used in place of *_spec/anal and \n'
                                 ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_eq_anal/detc': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                  ' containing the incident and diffracted beams) for\n'
                                  ' the instrument. Values are the maximum divergence angles in\n'
                                  ' degrees, as limited by Soller slits located thus:\n'
                                  '   *_src/mono, collimation between the radiation source\n'
                                  ...
                                  ' *_spec/detc is used in place of *_spec/anal and \n'
                                  ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_eq_mono/spec': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                  ' containing the incident and diffracted beams) for\n'
                                  ' the instrument. Values are the maximum divergence angles in\n'
                                  ' degrees, as limited by Soller slits located thus:\n'
                                  '   *_src/mono, collimation between the radiation source\n'
                                  ...
                                  ' *_spec/detc is used in place of *_spec/anal and \n'
                                  ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_eq_spec/anal': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                  ' containing the incident and diffracted beams) for\n'
                                  ' the instrument. Values are the maximum divergence angles in\n'
                                  ' degrees, as limited by Soller slits located thus:\n'
                                  '   *_src/mono, collimation between the radiation source\n'
                                  ...
                                  ' *_spec/detc is used in place of *_spec/anal and \n'
                                  ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_eq_spec/detc': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                  ' containing the incident and diffracted beams) for\n'
                                  ' the instrument. Values are the maximum divergence angles in\n'
                                  ' degrees, as limited by Soller slits located thus:\n'
                                  '   *_src/mono, collimation between the radiation source\n'
                                  ...
                                  ' *_spec/detc is used in place of *_spec/anal and \n'
                                  ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_eq_src/mono': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                 ' containing the incident and diffracted beams) for\n'
                                 ' the instrument. Values are the maximum divergence angles in\n'
                                 ' degrees, as limited by Soller slits located thus:\n'
                                 '   *_src/mono, collimation between the radiation source\n'
                                 ...
                                 ' *_spec/detc is used in place of *_spec/anal and \n'
                                 ' *_anal/detc if there is no analyser in use.</pre>',
 '_pd_instr_soller_eq_src/spec': '<pre> Describes collimation in the equatorial plane (the plane\n'
                                 ' containing the incident and diffracted beams) for\n'
                                 ' the instrument. Values are the maximum divergence angles in\n'
                                 ' degrees, as limited by Soller slits located thus:\n'
                                 '   *_src/mono, collimation between the radiation source\n'
 ...
 '_pd_instr_source_size_eq': '<pre> Axial and equatorial intrinsic dimensions\n'
                             ...
                             ' The perpendicular to the plane containing the incident\n'
                             ' and scattered beam is the axial (*_ax) direction.</pre>',
 '_pd_instr_special_details': '<pre> A brief description of the instrument giving\n'
                              ' details that cannot be given in other\n'
                              ' _pd_instr_ entries.</pre>',
 '_pd_instr_var_illum_len': '<pre> Length of the specimen that is illuminated by the radiation\n'
 ...
 '_pd_meas_2theta_fixed': '<pre> The 2\\q diffraction angle in degrees for measurements\n'
 ...
 '_pd_meas_2theta_range_inc': '<pre> The range of 2\\q diffraction angles in degrees for the\n'
 ...
 '_pd_meas_2theta_range_max': '<pre> The range of 2\\q diffraction angles in degrees for the\n'
                              ' measurement of intensities. These may be used in place of the\n'
                              ' _pd_meas_2theta_scan values for data sets measured with a\n'
                              ' constant step size.</pre>',
 '_pd_meas_2theta_range_min': '<pre> The range of 2\\q diffraction angles in degrees for the\n'
                              ' measurement of intensities. These may be used in place of the\n'
                              ' _pd_meas_2theta_scan values for data sets measured with a\n'
                              ' constant step size.</pre>',
 '_pd_meas_2theta_scan': '<pre> 2\\q diffraction angle (in degrees) for intensity\n'
 ...
 '_pd_meas_[pd]': '<pre> This section contains the measured diffractogram and information\n'
 ...
 '_pd_meas_angle_2theta': '<pre> The diffractometer angles in degrees for an instrument with a\n'
 ...
 '_pd_meas_angle_chi': '<pre> The diffractometer angles in degrees for an instrument with a\n'
                       ' Euler circle. The definitions for these angles follow the\n'
                       ' convention of International Tables for X-ray Crystallography\n'
                       ' (1974), Vol. IV, p. 276.</pre>',
 '_pd_meas_angle_omega': '<pre> The diffractometer angles in degrees for an instrument with a\n'
                         ' Euler circle. The definitions for these angles follow the\n'
                         ' convention of International Tables for X-ray Crystallography\n'
                         ' (1974), Vol. IV, p. 276.</pre>',
 '_pd_meas_angle_phi': '<pre> The diffractometer angles in degrees for an instrument with a\n'
                       ' Euler circle. The definitions for these angles follow the\n'
                       ' convention of International Tables for X-ray Crystallography\n'
                       ' (1974), Vol. IV, p. 276.</pre>',
 '_pd_meas_counts_background': '<pre> Counts measured at the measurement point as a function of\n'
 ...
 '_pd_meas_counts_container': '<pre> Counts measured at the measurement point as a function of\n'
                              ' angle, time, channel or some other variable (see\n'
                              ' _pd_meas_2theta_ etc.).\n'
                              '\n'
                              ' The defined fields are:\n'
                              ...
                              ' If the standard uncertainties differ from the square root of\n'
                              ' the number of counts, _pd_meas_intensity_ should be used.</pre>',
 '_pd_meas_counts_monitor': '<pre> Counts measured at the measurement point as a function of\n'
                            ' angle, time, channel or some other variable (see\n'
                            ' _pd_meas_2theta_ etc.).\n'
                            '\n'
                            ' The defined fields are:\n'
                            ...
                            ' If the standard uncertainties differ from the square root of\n'
                            ' the number of counts, _pd_meas_intensity_ should be used.</pre>',
 '_pd_meas_counts_total': '<pre> Counts measured at the measurement point as a function of\n'
                          ' angle, time, channel or some other variable (see\n'
                          ' _pd_meas_2theta_ etc.).\n'
                          '\n'
                          ' The defined fields are:\n'
                          ...
                          ' If the standard uncertainties differ from the square root of\n'
                          ' the number of counts, _pd_meas_intensity_ should be used.</pre>',
 '_pd_meas_datetime_initiated': '<pre> The date and time of the data-set measurement. Entries '
                                'follow\n'
 ...
 '_pd_meas_detector_id': '<pre> A code or number which identifies the measuring detector or\n'
 ...
 '_pd_meas_info_author_address': '<pre> The address of the person who measured the data set. If '
                                 'there\n'
                                 ' is more than one person, this will be looped with\n'
                                 ' _pd_meas_info_author_name.</pre>',
 '_pd_meas_info_author_email': '<pre> The e-mail address of the person who measured the data set. '
                               'If\n'
                               ' there is more than one person, this will be looped with\n'
                               ' _pd_meas_info_author_name.</pre>',
 '_pd_meas_info_author_fax': '<pre> The fax number of the person who measured the data set. If\n'
                             ' there is more than one person, this will be looped with\n'
 ...
 '_pd_meas_info_author_name': '<pre> The name of the person who measured the data set. The family\n'
                              ...
                              'values.</pre>',
 '_pd_meas_info_author_phone': '<pre> The telephone number of the person who measured the data '
                               'set.\n'
                               ' If there is more than one person, this will be looped with\n'
                               ' _pd_meas_info_author_name. The recommended style is\n'
                               ' the international dialing prefix, followed by the area code in\n'
                               ' parentheses, followed by the local number with no spaces.</pre>',
 '_pd_meas_intensity_background': '<pre> Intensity measurements at the measurement point (see\n'
 ...
 '_pd_meas_intensity_container': '<pre> Intensity measurements at the measurement point (see\n'
                                 ' the definition of _pd_meas_2theta_).\n'
                                 '\n'
                                 ' The defined fields are:\n'
                                 '   _pd_meas_intensity_total, scattering from the specimen\n'
                                 ...
                                 ' _pd_meas_units_of_intensity should be used to specify\n'
                                 ' the units of the intensity measurements.</pre>',
 '_pd_meas_intensity_monitor': '<pre> Intensity measurements at the measurement point (see\n'
                               ' the definition of _pd_meas_2theta_).\n'
                               '\n'
                               ' The defined fields are:\n'
                               '   _pd_meas_intensity_total, scattering from the specimen\n'
                               ...
                               ' _pd_meas_units_of_intensity should be used to specify\n'
                               ' the units of the intensity measurements.</pre>',
 '_pd_meas_intensity_total': '<pre> Intensity measurements at the measurement point (see\n'
                             ' the definition of _pd_meas_2theta_).\n'
                             '\n'
                             ' The defined fields are:\n'
                             '   _pd_meas_intensity_total, scattering from the specimen\n'
                             ...
                             ' _pd_meas_units_of_intensity should be used to specify\n'
                             ' the units of the intensity measurements.</pre>',
 '_pd_meas_number_of_points': '<pre> The total number of points in the measured\n'
                              ' diffractogram.</pre>',
 '_pd_meas_point_id': '<pre> Arbitrary label identifying a measured data point. Used to\n'
 ...
 '_pd_meas_position': '<pre> A linear distance in millimetres corresponding to the\n'
 ...
 '_pd_meas_rocking_angle': '<pre> The angular range in degrees through which a sample is rotated\n'
 ...
 '_pd_meas_step_count_time': '<pre> The count time in seconds for each intensity measurement.\n'
 ...
 '_pd_meas_time_of_flight': '<pre> Measured time in microseconds for time-of-flight neutron\n'
                            ' measurements. Note that the flight distance may be\n'
                            ' specified using _pd_instr_dist_ values.</pre>',
 '_pd_meas_units_of_intensity': '<pre> Units for intensity measurements when _pd_meas_intensity_\n'
 ...
 '_pd_peak_2theta_centroid': '<pre> Position of the centroid and maximum of a peak as a\n'
                             ' 2\\q angle in degrees.</pre>',
 '_pd_peak_2theta_maximum': '<pre> Position of the centroid and maximum of a peak as a\n'
                            ' 2\\q angle in degrees.</pre>',
 '_pd_peak_[pd]': '<pre> This section contains peak information extracted from the\n'
 ...
 '_pd_peak_id': '<pre> An arbitrary code is assigned to each peak. Used to link with\n'
 ...
 '_pd_peak_intensity': '<pre> Integrated area for the peak, with the same scaling as\n'
                       ' the _pd_proc_intensity_ values. It is good practice to\n'
                       " include s.u.'s for these values.</pre>",
 '_pd_peak_pk_height': '<pre> The maximum intensity of the peak, either extrapolated\n'
 ...
 '_pd_peak_special_details': '<pre> Detailed description of any non-routine processing steps\n'
                             ' used for peak determination or other comments\n'
                             ' related to the peak table that cannot be given elsewhere.</pre>',
 '_pd_peak_wavelength_id': '<pre> Code identifying the wavelength appropriate for this peak\n'
                           ...
                           ' wavelength.</pre>',
 '_pd_peak_width_2theta': '<pre> Peak width as full-width at half-maximum expressed as\n'
                          ' a 2\\q value in degrees.</pre>',
 '_pd_peak_width_d_spacing': '<pre> Peak width as full-width at half-maximum expressed as\n'
                             ' a d-spacing in angstroms.</pre>',
 '_pd_phase_[pd]': '<pre> This section contains a description of the crystalline phases\n'
 ...
 '_pd_phase_block_id': '<pre> A block ID code identifying the phase contributing to\n'
 ...
 '_pd_phase_mass_%': '<pre> Per cent composition of the specified crystal phase\n'
                     ' expressed as the total mass of the component\n'
                     ' with respect to the total mass of the specimen.</pre>',
 '_pd_phase_name': '<pre> The name of the crystal phase identified by _pd_phase_id.\n'
                   ' It may be designated as unknown or by a structure type etc.</pre>',
 '_pd_prep_[pd]': '<pre> This section contains descriptive information about how the\n'
                  ' sample was prepared.</pre>',
 '_pd_prep_conditions': '<pre> A description of how the material was prepared\n'
                        ' (reaction conditions etc.)</pre>',
 '_pd_prep_cool_rate': '<pre> Cooling rate in kelvins per minute for samples prepared\n'
 ...
 '_pd_prep_pressure': '<pre> Preparation pressure of the sample in kilopascals. This\n'
                      ' is particularly important for materials which are metastable\n'
                      ' at the measurement pressure, _diffrn_ambient_pressure.</pre>',
 '_pd_prep_temperature': '<pre> Preparation temperature of the sample in kelvins. This is\n'
                         ' particularly important for materials which are metastable\n'
                         ' at the measurement temperature, _diffrn_ambient_temperature.</pre>',
 '_pd_proc_2theta_corrected': '<pre> The 2\\q diffraction angle in degrees of an intensity\n'
 ...
 '_pd_proc_2theta_range_inc': '<pre> The range of 2\\q diffraction angles in degrees for the\n'
                              ' measurement of intensities. These may be used in place of the\n'
                              ' _pd_proc_2theta_corrected values, or in the case of white-beam\n'
                              ' experiments it will define the fixed 2\\q value.</pre>',
 '_pd_proc_2theta_range_max': '<pre> The range of 2\\q diffraction angles in degrees for the\n'
                              ' measurement of intensities. These may be used in place of the\n'
                              ' _pd_proc_2theta_corrected values, or in the case of white-beam\n'
                              ' experiments it will define the fixed 2\\q value.</pre>',
 '_pd_proc_2theta_range_min': '<pre> The range of 2\\q diffraction angles in degrees for the\n'
                              ' measurement of intensities. These may be used in place of the\n'
                              ' _pd_proc_2theta_corrected values, or in the case of white-beam\n'
                              ' experiments it will define the fixed 2\\q value.</pre>',
 '_pd_proc_[pd]': '<pre> This section contains the diffraction data set after processing\n'
 ...
 '_pd_proc_energy_detection': '<pre> Incident energy in electronvolts of the source computed\n'
                              ...
                              'data).</pre>',
 '_pd_proc_energy_incident': '<pre> Incident energy in electronvolts of the source computed\n'
                             ' from secondary calibration information (time-of-flight\n'
                             ' and synchrotron data).\n'
                             ' Detection energy in electronvolts selected by the analyser,\n'
                             ' if not the same as the incident energy (triple-axis or \n'
                             ...
                             ' vary for each data point (triple-axis and time-of-flight '
                             'data).</pre>',
 '_pd_proc_info_author_address': '<pre>  The address of the person who processed the data.\n'
                                 '  If there is more than one person, this will be looped with\n'
                                 '  _pd_proc_info_author_name.</pre>',
 '_pd_proc_info_author_email': '<pre>  The e-mail address of the person who processed the\n'
                               '  data.  If there is more than one person, this will be looped\n'
                               '  with _pd_proc_info_author_name.</pre>',
 '_pd_proc_info_author_fax': '<pre>  The fax number of the person who processed the data.\n'
                             '  If there is more than one person, this will be looped with\n'
                             '  _pd_proc_info_author_name. The recommended style is\n'
                             '  the international dialing prefix, followed by the area code in\n'
                             '  parentheses, followed by the local number with no spaces.</pre>',
 '_pd_proc_info_author_name': '<pre>  The name of the person who processed the data, if different\n'
 ...
 '_pd_proc_info_author_phone': '<pre>  The telephone number of the person who processed the data.\n'
                               '  If there is more than one person, this will be looped\n'
                               '  with _pd_proc_info_author_name. The recommended style is\n'
                               '  the international dialing prefix, followed by the area code in\n'
                               '  parentheses, followed by the local number with no spaces.</pre>',
 '_pd_proc_info_data_reduction': '<pre> Description of the processing steps applied in the '
                                 'data-reduction\n'
                                 ' process (background subtraction, \\a-2 stripping, smoothing\n'
                                 ' etc.). Include details of the program(s) used etc.</pre>',
 '_pd_proc_info_datetime': '<pre> Date(s) and time(s) when the data set was processed.\n'
                           ...
                           'Example:\n'
                           '1990-07-13T14:40</pre>',
 '_pd_proc_info_excluded_regions': '<pre> Description of regions in the diffractogram excluded\n'
 ...
 '_pd_proc_info_special_details': '<pre> Detailed description of any non-routine processing steps\n'
                                  ' applied due to any irregularities in this particular data '
                                  'set.</pre>',
 '_pd_proc_intensity_bkg_calc': '<pre> _pd_proc_intensity_net contains intensity values for the\n'
 ...
 '_pd_proc_intensity_bkg_fix': '<pre> _pd_proc_intensity_net contains intensity values for the\n'
                               ' processed diffractogram for each data point (see\n'
                               ' _pd_proc_2theta_, _pd_proc_wavelength etc.) after\n'
                               ' correction and normalization factors have been applied\n'
                               ' (in contrast to _pd_meas_counts_ values, which are\n'
                               ...
                               ' The function should be specified as the one used to divide the\n'
                               ' measured intensities.</pre>',
 '_pd_proc_intensity_incident': '<pre> _pd_proc_intensity_net contains intensity values for the\n'
                                ' processed diffractogram for each data point (see\n'
                                ' _pd_proc_2theta_, _pd_proc_wavelength etc.) after\n'
                                ' correction and normalization factors have been applied\n'
                                ' (in contrast to _pd_meas_counts_ values, which are\n'
                                ...
                                ' The function should be specified as the one used to divide the\n'
                                ' measured intensities.</pre>',
 '_pd_proc_intensity_net': '<pre> _pd_proc_intensity_net contains intensity values for the\n'
                           ' processed diffractogram for each data point (see\n'
                           ' _pd_proc_2theta_, _pd_proc_wavelength etc.) after\n'
                           ' correction and normalization factors have been applied\n'
                           ' (in contrast to _pd_meas_counts_ values, which are\n'
                           ...
                           ' The function should be specified as the one used to divide the\n'
                           ' measured intensities.</pre>',
 '_pd_proc_intensity_norm': '<pre> _pd_proc_intensity_net contains intensity values for the\n'
                            ' processed diffractogram for each data point (see\n'
                            ' _pd_proc_2theta_, _pd_proc_wavelength etc.) after\n'
                            ' correction and normalization factors have been applied\n'
                            ' (in contrast to _pd_meas_counts_ values, which are\n'
                            ...
                            ' The function should be specified as the one used to divide the\n'
                            ' measured intensities.</pre>',
 '_pd_proc_intensity_total': '<pre> _pd_proc_intensity_net contains intensity values for the\n'
                             ' processed diffractogram for each data point (see\n'
                             ' _pd_proc_2theta_, _pd_proc_wavelength etc.) after\n'
                             ' correction and normalization factors have been applied\n'
                             ' (in contrast to _pd_meas_counts_ values, which are\n'
                             ...
                             ' The function should be specified as the one used to divide the\n'
                             ' measured intensities.</pre>',
 '_pd_proc_ls_[pd]': '<pre> This section is used to define parameters relevant to a\n'
 ...
 '_pd_proc_ls_background_function': '<pre> Description of the background treatment mechanism used '
                                    'to\n'
                                    ' fit the data set.\n'
                                    '\n'
 ...
 '_pd_proc_ls_peak_cutoff': '<pre> Describes where peak-intensity computation is\n'
 ...
 '_pd_proc_ls_pref_orient_corr': '<pre> Description of the preferred-orientation correction if\n'
 ...
 '_pd_proc_ls_prof_wR_factor': '<pre> Rietveld/profile fit R factors.\n'
                               ...
                               '          data points excluded from the refinement.\n'
                               '     p is the total number of refined parameters.</pre>',
 '_pd_proc_ls_profile_function': '<pre> Description of the profile function used to\n'
 ...
 '_pd_proc_ls_special_details': '<pre> Additional characterization information relevant to\n'
                                ' non-routine steps used for refinement of a structural model\n'
                                ' that cannot be specified elsewhere.</pre>',
 '_pd_proc_ls_weight': '<pre> Weight applied to each profile point. These values\n'
 ...
 '_pd_proc_number_of_points': '<pre> The total number of data points in the processed '
                              'diffractogram.</pre>',
 '_pd_proc_point_id': '<pre> Arbitrary label identifying a processed data point. Used to\n'
                      ...
                      ' combined.</pre>',
 '_pd_proc_recip_len_Q': '<pre> Length in reciprocal space (|Q|= 2\\p/d) corresponding to\n'
                         ' an intensity point. Units are inverse angstroms.</pre>',
 '_pd_proc_wavelength': '<pre> Wavelength in angstroms for the incident radiation as\n'
                        ...
                        ' measurements.</pre>',
 '_pd_refln_[pd]': '<pre> This section provides a mechanism to identify each peak in the\n'
 ...
 '_pd_refln_peak_id': '<pre> Code which identifies the powder diffraction peak that\n'
                      ' contains the current reflection. This code must match a\n'
                      ' _pd_peak_id code.</pre>',
 '_pd_refln_phase_id': '<pre> Code which identifies the crystal phase associated with this\n'
                       ' reflection. This code must match a _pd_phase_id code.</pre>',
 '_pd_refln_wavelength_id': '<pre> Code which identifies the wavelength associated with the\n'
                            ' reflection and the peak pointed to by _pd_refln_peak_id.\n'
                            ' This code must match a _diffrn_radiation_wavelength_id code.</pre>',
 '_pd_spec_[pd]': '<pre> This section contains information about the specimen used\n'
 ...
 '_pd_spec_orientation': '<pre> The orientation of the \\w (\\q) and 2\\q axis.\n'
 ...
 '_pd_spec_size_axial': '<pre> The size of the specimen in three mutually perpendicular\n'
                        ...
                        ' parallel to *_thick.\n'
                        '</pre>',
 '_pd_spec_size_equat': '<pre> The size of the specimen in three mutually perpendicular\n'
                        ' directions in millimetres.\n'
                        ' The perpendicular to the plane containing the incident\n'
                        ' and scattered beam is the *_axial direction.\n'
                        ' In transmission geometry, the scattering vector is parallel\n'
                        ...
                        ' parallel to *_thick.\n'
                        '</pre>',
 '_pd_spec_size_thick': '<pre> The size of the specimen in three mutually perpendicular\n'
                        ' directions in millimetres.\n'
                        ' The perpendicular to the plane containing the incident\n'
                        ' and scattered beam is the *_axial direction.\n'
                        ' In transmission geometry, the scattering vector is parallel\n'
                        ...
                        ' parallel to *_thick.\n'
                        '</pre>',
 '_pd_spec_special_details': '<pre> Descriptive information about the specimen that cannot be\n'
