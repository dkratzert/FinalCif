...
class Ui_FinalCifWindow(object):
    def setupUi(self, FinalCifWindow):
        ...
        sizePolicy16.setHeightForWidth(self.groupBox_7.sizePolicy().hasHeightForWidth())
        self.groupBox_7.setSizePolicy(sizePolicy16)
        ...
        sizePolicy28.setHeightForWidth(self.groupBox_71.sizePolicy().hasHeightForWidth())
        self.groupBox_71.setSizePolicy(sizePolicy28)
