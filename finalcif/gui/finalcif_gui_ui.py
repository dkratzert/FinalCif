...
class Ui_FinalCifWindow(object):
    def setupUi(self, FinalCifWindow):
        ...
        self.LeftFrame = QtWidgets.QFrame(self.Mainwidget)
        ...
        self.horizontalLayout_4.addWidget(self.CifDataItemsFrame)
