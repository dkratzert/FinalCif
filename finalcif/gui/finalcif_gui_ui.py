...
class Ui_FinalCifWindow(object):
    def setupUi(self, FinalCifWindow):
        ...
        sizePolicy9.setHeightForWidth(self.cellField.sizePolicy().hasHeightForWidth())
        self.cellField.setSizePolicy(sizePolicy9)
        ...
        sizePolicy10.setHorizontalStretch(45)
        sizePolicy10.setVerticalStretch(80)
        sizePolicy10.setHeightForWidth(self.groupBox_9.sizePolicy().hasHeightForWidth())
        self.groupBox_9.setSizePolicy(sizePolicy10)
        ...
        sizePolicy11.setHeightForWidth(self.shelx_TextEdit.sizePolicy().hasHeightForWidth())
        self.shelx_TextEdit.setSizePolicy(sizePolicy11)
        font3 = QFont()
        ...
        sizePolicy12.setHeightForWidth(self.shelx_warn_TextEdit.sizePolicy().hasHeightForWidth())
        self.shelx_warn_TextEdit.setSizePolicy(sizePolicy12)
        font4 = QFont()
        ...
        sizePolicy13.setHeightForWidth(self.molGroupBox.sizePolicy().hasHeightForWidth())
        self.molGroupBox.setSizePolicy(sizePolicy13)
        ...
        sizePolicy14.setHeightForWidth(self.render_widget.sizePolicy().hasHeightForWidth())
        self.render_widget.setSizePolicy(sizePolicy14)
        ...
        self.video_vLayout = QVBoxLayout(self.frame_3)
        ...
        self.pushButton = QPushButton(self.tab_video)
        ...
        sizePolicy16.setHorizontalStretch(50)
        sizePolicy16.setVerticalStretch(0)
        sizePolicy16.setHeightForWidth(self.groupBox_COD.sizePolicy().hasHeightForWidth())
        self.groupBox_COD.setSizePolicy(sizePolicy16)
        ...
        sizePolicy17.setHeightForWidth(self.groupBox_71.sizePolicy().hasHeightForWidth())
        self.groupBox_71.setSizePolicy(sizePolicy17)
        ...
        sizePolicy18.setHorizontalStretch(15)
        sizePolicy18.setVerticalStretch(0)
        sizePolicy18.setHeightForWidth(self.groupBox_8.sizePolicy().hasHeightForWidth())
        self.groupBox_8.setSizePolicy(sizePolicy18)
        ...
        sizePolicy18.setHeightForWidth(self.groupBox_10.sizePolicy().hasHeightForWidth())
        self.groupBox_10.setSizePolicy(sizePolicy18)
        ...
        self.textSizeSpinBox.setObjectName(u"textSizeSpinBox")
        ...
        sizePolicy19 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Expanding)
        sizePolicy19.setHorizontalStretch(30)
        sizePolicy19.setVerticalStretch(2)
        sizePolicy19.setHeightForWidth(self.cifOrderWidget.sizePolicy().hasHeightForWidth())
        self.cifOrderWidget.setSizePolicy(sizePolicy19)
        ...
        sizePolicy20.setHorizontalStretch(50)
        sizePolicy20.setVerticalStretch(2)
        sizePolicy20.setHeightForWidth(self.PropertiesGroupBox.sizePolicy().hasHeightForWidth())
        self.PropertiesGroupBox.setSizePolicy(sizePolicy20)
        ...
        sizePolicy21 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Fixed)
        sizePolicy21.setHorizontalStretch(1)
        sizePolicy21.setVerticalStretch(0)
        sizePolicy21.setHeightForWidth(self.DeletePropertiesButton.sizePolicy().hasHeightForWidth())
        self.DeletePropertiesButton.setSizePolicy(sizePolicy21)
        ...
        sizePolicy22.setHeightForWidth(self.SavePropertiesButton.sizePolicy().hasHeightForWidth())
        self.SavePropertiesButton.setSizePolicy(sizePolicy22)
        ...
        sizePolicy21.setHeightForWidth(self.CancelPropertiesButton.sizePolicy().hasHeightForWidth())
        self.CancelPropertiesButton.setSizePolicy(sizePolicy21)
        ...
        sizePolicy23.setHorizontalStretch(45)
        sizePolicy23.setVerticalStretch(0)
        sizePolicy23.setHeightForWidth(self.authorEditTabWidget.sizePolicy().hasHeightForWidth())
        self.authorEditTabWidget.setSizePolicy(sizePolicy23)
        ...
        sizePolicy24 = QSizePolicy(QSizePolicy.Policy.Preferred, QSizePolicy.Policy.Fixed)
        sizePolicy24.setHorizontalStretch(0)
        sizePolicy24.setVerticalStretch(0)
        sizePolicy24.setHeightForWidth(self.label_13.sizePolicy().hasHeightForWidth())
        self.label_13.setSizePolicy(sizePolicy24)
        ...
        sizePolicy25.setHeightForWidth(self.AddThisAuthorToLoopPushButton_cif.sizePolicy().hasHeightForWidth())
        self.AddThisAuthorToLoopPushButton_cif.setSizePolicy(sizePolicy25)
        ...
        sizePolicy26 = QSizePolicy(QSizePolicy.Policy.Expanding, QSizePolicy.Policy.Preferred)
        sizePolicy26.setHorizontalStretch(55)
        sizePolicy26.setVerticalStretch(0)
        sizePolicy26.setHeightForWidth(self.frame_2.sizePolicy().hasHeightForWidth())
        self.frame_2.setSizePolicy(sizePolicy26)
    ...
    def retranslateUi(self, FinalCifWindow):
        ...
        self.pushButton.setText(QCoreApplication.translate("FinalCifWindow", u"Use picture for report", None))
...
"The data source will be ignored until next program restart.", None))
        ...
        self.groupBox_71.setTitle(QCoreApplication.translate("FinalCifWindow", u"CheckCIF Server", None))
...
" \"[name]-finalcif_changes.cif\".", None))
        self.label_26.setText(QCoreApplication.translate("FinalCifWindow", u"Application font size", None))
