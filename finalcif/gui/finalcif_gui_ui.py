...
class Ui_FinalCifWindow(object):
    def setupUi(self, FinalCifWindow):
        ...
        FinalCifWindow.resize(1680, 951)
        ...
        self.verticalLayout_8.setContentsMargins(6, 3, 0, 8)
        ...
        self.video_vLayout = QVBoxLayout()
        self.video_vLayout.setObjectName(u"video_vLayout")

        self.verticalLayout_44.addLayout(self.video_vLayout)
