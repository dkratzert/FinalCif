...
class Ui_LoopCreator(object):
    def setupUi(self, LoopCreator):
        ...
        self.lineEdit = QtWidgets.QLineEdit(LoopCreator)
        self.lineEdit.setObjectName("lineEdit")
        self.horizontalLayout.addWidget(self.lineEdit)
        self.verticalLayout_2.addLayout(self.horizontalLayout)
        self.listWidget = QtWidgets.QListWidget(LoopCreator)
        ...
        self.pushButton_2 = QtWidgets.QPushButton(LoopCreator)
        self.pushButton_2.setObjectName("pushButton_2")
        self.verticalLayout.addWidget(self.pushButton_2)
        self.pushButton = QtWidgets.QPushButton(LoopCreator)
        ...
        self.listWidget_2 = QtWidgets.QListWidget(LoopCreator)
        self.listWidget_2.setObjectName("listWidget_2")
        self.verticalLayout_3.addWidget(self.listWidget_2)
        self.pushButton_3 = QtWidgets.QPushButton(LoopCreator)
    ...
    def retranslateUi(self, LoopCreator):
        ...
        self.pushButton_2.setText(_translate("LoopCreator", "<--"))
        self.pushButton.setText(_translate("LoopCreator", "-->"))
        ...
        self.pushButton_3.setText(_translate("LoopCreator", "Save new Loop"))
