...
class Text(str):
    TOKEN_SLOTS = ['parentNode','contextDepth','ownerDocument','isMarkup']
    #def __init__(self, *v, **k):
    #    self.TOKEN_SLOTS = ['parentNode','contextDepth','ownerDocument','isMarkup']
    #    super().__init__(*v, **k)



###################### taken from Tokenizer.py
