...
class StatusBar:
    ...
    def __init__(self, ui: Ui_FinalCifWindow | None = None):
        self.ui = ui
        self._message = ''
        if ui:
            self.graphics = True
    ...
    def message_to_string(self, message: str | list) -> str:
        if isinstance(message, list):
            return ' '.join(message)
        return message

    def show_message(self, message: str | list, timeout: int = 0) -> None:
