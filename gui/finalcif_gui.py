...
"}")
        ...
        self.LoopTemplatesListWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.LoopTemplatesListWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.LoopTemplatesListWidget.addItem(item)
        ...
        self.EditLoopTemplateButton = QtWidgets.QPushButton(self.LoopsGroupBox)
        self.EditLoopTemplateButton.setObjectName("EditLoopTemplateButton")
        self.horizontalLayout_7.addWidget(self.EditLoopTemplateButton)
        self.ImportLoopTemplateButton = QtWidgets.QPushButton(self.LoopsGroupBox)
        self.ImportLoopTemplateButton.setObjectName("ImportLoopTemplateButton")
        self.horizontalLayout_7.addWidget(self.ImportLoopTemplateButton)
        ...
        self.gridLayout_16.addWidget(self.revertLoopsPushButton, 0, 3, 1, 1)
        self.SaveDelExpLoopsLayout = QtWidgets.QHBoxLayout()
        self.SaveDelExpLoopsLayout.setObjectName("SaveDelExpLoopsLayout")
        spacerItem21 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.SaveDelExpLoopsLayout.addItem(spacerItem21)
        self.SaveLoopButton = QtWidgets.QPushButton(self.page_Loops)
        self.SaveLoopButton.setObjectName("SaveLoopButton")
        self.SaveDelExpLoopsLayout.addWidget(self.SaveLoopButton)
        self.DeleteLoopButton = QtWidgets.QPushButton(self.page_Loops)
        self.DeleteLoopButton.setObjectName("DeleteLoopButton")
        self.SaveDelExpLoopsLayout.addWidget(self.DeleteLoopButton)
        self.ExportLoopButton = QtWidgets.QPushButton(self.page_Loops)
        self.ExportLoopButton.setObjectName("ExportLoopButton")
        self.SaveDelExpLoopsLayout.addWidget(self.ExportLoopButton)
        self.gridLayout_16.addLayout(self.SaveDelExpLoopsLayout, 0, 1, 1, 1)
        ...
        self.gridLayout_16.addItem(spacerItem24, 0, 4, 1, 1)
    ...
    def retranslateUi(self, FinalCifWindow):
        ...
        self.LoopsGroupBox.setTitle(_translate("FinalCifWindow", "Loop Templates"))
        ...
        __sortingEnabled = self.LoopTemplatesListWidget.isSortingEnabled()
        self.LoopTemplatesListWidget.setSortingEnabled(False)
        item = self.LoopTemplatesListWidget.item(0)
        item.setText(_translate("FinalCifWindow", "Authors"))
        item = self.LoopTemplatesListWidget.item(1)
        item.setText(_translate("FinalCifWindow", "Citations"))
        item = self.LoopTemplatesListWidget.item(2)
        item.setText(_translate("FinalCifWindow", "Citation ShelXle"))
        self.LoopTemplatesListWidget.setSortingEnabled(__sortingEnabled)
        self.NewLoopTemplateButton.setText(_translate("FinalCifWindow", "New Loop"))
        self.EditLoopTemplateButton.setText(_translate("FinalCifWindow", "Edit Loop"))
...
"The data source will be ignored until next program restart."))
        ...
        self.SaveLoopButton.setText(_translate("FinalCifWindow", "Save Loop"))
