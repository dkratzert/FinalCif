...
"}")
        ...
        self.gridLayout_12 = QtWidgets.QGridLayout(self.page_Loops)
        self.gridLayout_12.setObjectName("gridLayout_12")
        self.BackFromLooptableButton = QtWidgets.QPushButton(self.page_Loops)
        self.BackFromLooptableButton.setObjectName("BackFromLooptableButton")
        self.gridLayout_12.addWidget(self.BackFromLooptableButton, 1, 0, 1, 1)
        self.LoopTableV = QtWidgets.QTableView(self.page_Loops)
        self.LoopTableV.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.LoopTableV.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.LoopTableV.setObjectName("LoopTableV")
        self.LoopTableV.horizontalHeader().setCascadingSectionResizes(True)
        self.LoopTableV.horizontalHeader().setDefaultSectionSize(100)
        self.LoopTableV.horizontalHeader().setStretchLastSection(False)
        self.LoopTableV.verticalHeader().setVisible(False)
        self.LoopTableV.verticalHeader().setMinimumSectionSize(24)
        self.gridLayout_12.addWidget(self.LoopTableV, 0, 0, 1, 2)
        ...
        self.InfobarHLayout.addItem(spacerItem16)
...
"The data source will be ignored until next program restart."))
        ...
        self.BackFromLooptableButton.setText(_translate("FinalCifWindow", "Back to CIF Table"))
