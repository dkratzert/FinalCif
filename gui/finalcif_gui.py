...
"please add a publication author:"))
        ...
        self.depositHKLcheckBox.setText(_translate("FinalCifWindow", "deposit included hkl data"))
        self.Upload_hkl_pushButton.setText(_translate("FinalCifWindow", "upload structure factors"))
