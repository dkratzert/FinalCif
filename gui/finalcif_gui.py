...
"}")
        ...
        self.gridLayout_23.addWidget(self.cod_database_code_LineEdit, 1, 1, 1, 1)
        spacerItem42 = QtWidgets.QSpacerItem(80, 20, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_23.addItem(spacerItem42, 1, 2, 1, 1)
...
"Contact authors should always also appear as regular authors."))
        ...
        self.label_10.setText(_translate("FinalCifWindow", "<b>A personal communication to the COD makes the uploaded CIF data public to everyone.</b>"))
