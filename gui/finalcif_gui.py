...
class Ui_FinalCifWindow(object):
    def setupUi(self, FinalCifWindow):
        ...
        self.EquipmentTableWidget.setColumnCount(2)
        self.EquipmentTableWidget.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.EquipmentTableWidget.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.EquipmentTableWidget.setHorizontalHeaderItem(1, item)
    ...
    def retranslateUi(self, FinalCifWindow):
        ...
        item = self.EquipmentTableWidget.horizontalHeaderItem(1)
