...
class Ui_FinalCifWindow(object):
    def setupUi(self, FinalCifWindow):
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(self.page_MainTable)
        self.groupBox_2.setTitle("")
        self.groupBox_2.setObjectName("groupBox_2")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.groupBox_2)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.CheckcifButton = QtWidgets.QPushButton(self.groupBox_2)
        self.CheckcifButton.setObjectName("CheckcifButton")
        self.verticalLayout_5.addWidget(self.CheckcifButton)
        self.CheckcifOnlineButton = QtWidgets.QPushButton(self.groupBox_2)
        self.CheckcifOnlineButton.setObjectName("CheckcifOnlineButton")
        self.verticalLayout_5.addWidget(self.CheckcifOnlineButton)
        self.ButtonsHorizontalLayout.addWidget(self.groupBox_2)
        self.groupBox = QtWidgets.QGroupBox(self.page_MainTable)
        self.groupBox.setTitle("")
        self.groupBox.setObjectName("groupBox")
        self.verticalLayout_4 = QtWidgets.QVBoxLayout(self.groupBox)
        self.verticalLayout_4.setObjectName("verticalLayout_4")
        self.SaveFullReportButton = QtWidgets.QPushButton(self.groupBox)
        self.SaveFullReportButton.setObjectName("SaveFullReportButton")
        self.verticalLayout_4.addWidget(self.SaveFullReportButton)
        self.HAtomsCheckBox = QtWidgets.QCheckBox(self.groupBox)
    ...
    def retranslateUi(self, FinalCifWindow):
        ...
        self.CheckcifOnlineButton.setText(_translate("FinalCifWindow", "Checkcif Online"))
