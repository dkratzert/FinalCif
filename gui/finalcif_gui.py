...
"}")
        ...
        self.TemplatesStackedWidget.setLineWidth(0)
        ...
        self.EquipmentGroupBox.setFlat(True)
        ...
        self.TemplatesGridLayout.setContentsMargins(0, 6, 0, 6)
        self.TemplatesGridLayout.setHorizontalSpacing(6)
        ...
        self.TemplatesGridLayout.addWidget(self.EditEquipmentTemplateButton, 2, 1, 1, 1)
        ...
        self.TemplatesGridLayout.addWidget(self.NewEquipmentTemplateButton, 2, 0, 1, 1)
        ...
        self.TemplatesGridLayout.addWidget(self.EquipmentTemplatesListWidget, 1, 0, 1, 3)
        self.line = QtWidgets.QFrame(self.EquipmentSelectPage)
        self.line.setFrameShape(QtWidgets.QFrame.HLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.TemplatesGridLayout.addWidget(self.line, 3, 0, 1, 3)
        ...
        self.TemplatesGridLayout.addWidget(self.ImportEquipmentTemplateButton, 2, 2, 1, 1)
        self.ImportCifPushButton = QtWidgets.QPushButton(self.EquipmentSelectPage)
        self.ImportCifPushButton.setObjectName("ImportCifPushButton")
        self.TemplatesGridLayout.addWidget(self.ImportCifPushButton, 4, 0, 1, 3)
        self.PropertiesGroupBox = QtWidgets.QGroupBox(self.EquipmentSelectPage)
        self.PropertiesGroupBox.setFlat(True)
        ...
        self.TemplatesGridLayout_2.setContentsMargins(0, 6, 0, 0)
        self.TemplatesGridLayout_2.setHorizontalSpacing(6)
        ...
        self.TemplatesGridLayout.addWidget(self.PropertiesGroupBox, 5, 0, 1, 3)
        ...
        self.EquipmentGroupBox_2 = QtWidgets.QGroupBox(self.page_loops)
        self.EquipmentGroupBox_2.setFlat(True)
        self.EquipmentGroupBox_2.setObjectName("EquipmentGroupBox_2")
        self.verticalLayout_17 = QtWidgets.QVBoxLayout(self.EquipmentGroupBox_2)
        self.verticalLayout_17.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_17.setSpacing(0)
        self.verticalLayout_17.setObjectName("verticalLayout_17")
        self.EquipmentTemplatesStackedWidget_2 = QtWidgets.QStackedWidget(self.EquipmentGroupBox_2)
        self.EquipmentTemplatesStackedWidget_2.setObjectName("EquipmentTemplatesStackedWidget_2")
        self.EquipmentSelectPage_2 = QtWidgets.QWidget()
        self.EquipmentSelectPage_2.setObjectName("EquipmentSelectPage_2")
        self.TemplatesGridLayout_3 = QtWidgets.QGridLayout(self.EquipmentSelectPage_2)
        self.TemplatesGridLayout_3.setContentsMargins(0, 6, 0, 6)
        self.TemplatesGridLayout_3.setHorizontalSpacing(6)
        self.TemplatesGridLayout_3.setObjectName("TemplatesGridLayout_3")
        spacerItem = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.TemplatesGridLayout_3.addItem(spacerItem, 4, 0, 1, 1)
        self.line_2 = QtWidgets.QFrame(self.EquipmentSelectPage_2)
        self.line_2.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.TemplatesGridLayout_3.addWidget(self.line_2, 3, 0, 1, 3)
        self.LoopTemplatesListWidget = QtWidgets.QListWidget(self.EquipmentSelectPage_2)
        font = QtGui.QFont()
        font.setPointSize(11)
        ...
        self.TemplatesGridLayout_3.addWidget(self.LoopTemplatesListWidget, 1, 0, 1, 3)
        self.NewLoopTemplateButton = QtWidgets.QPushButton(self.EquipmentSelectPage_2)
        self.NewLoopTemplateButton.setObjectName("NewLoopTemplateButton")
        self.TemplatesGridLayout_3.addWidget(self.NewLoopTemplateButton, 2, 0, 1, 1)
        self.EditLoopTemplateButton = QtWidgets.QPushButton(self.EquipmentSelectPage_2)
        self.EditLoopTemplateButton.setObjectName("EditLoopTemplateButton")
        self.TemplatesGridLayout_3.addWidget(self.EditLoopTemplateButton, 2, 1, 1, 1)
        self.ImportLoopTemplateButton = QtWidgets.QPushButton(self.EquipmentSelectPage_2)
        self.ImportLoopTemplateButton.setObjectName("ImportLoopTemplateButton")
        self.TemplatesGridLayout_3.addWidget(self.ImportLoopTemplateButton, 2, 2, 1, 1)
        self.EquipmentTemplatesStackedWidget_2.addWidget(self.EquipmentSelectPage_2)
        self.EquipmentEditPage_2 = QtWidgets.QWidget()
        self.EquipmentEditPage_2.setObjectName("EquipmentEditPage_2")
        self.gridLayout_18 = QtWidgets.QGridLayout(self.EquipmentEditPage_2)
        self.gridLayout_18.setObjectName("gridLayout_18")
        self.horizontalLayout_8 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_8.setObjectName("horizontalLayout_8")
        self.DeleteLoopButton = QtWidgets.QPushButton(self.EquipmentEditPage_2)
        self.DeleteLoopButton.setObjectName("DeleteLoopButton")
        self.horizontalLayout_8.addWidget(self.DeleteLoopButton)
        self.SaveLoopButton = QtWidgets.QPushButton(self.EquipmentEditPage_2)
        self.SaveLoopButton.setObjectName("SaveLoopButton")
        self.horizontalLayout_8.addWidget(self.SaveLoopButton)
        self.CancelLoopButton = QtWidgets.QPushButton(self.EquipmentEditPage_2)
        self.CancelLoopButton.setObjectName("CancelLoopButton")
        self.horizontalLayout_8.addWidget(self.CancelLoopButton)
        self.ExportLoopButton = QtWidgets.QPushButton(self.EquipmentEditPage_2)
        self.ExportLoopButton.setObjectName("ExportLoopButton")
        self.horizontalLayout_8.addWidget(self.ExportLoopButton)
        self.gridLayout_18.addLayout(self.horizontalLayout_8, 2, 1, 1, 4)
        self.LoopEditTableWidget = MyEQTableWidget(self.EquipmentEditPage_2)
        self.LoopEditTableWidget.setAutoScroll(False)
        self.LoopEditTableWidget.setEditTriggers(QtWidgets.QAbstractItemView.AllEditTriggers)
        self.LoopEditTableWidget.setAlternatingRowColors(False)
        self.LoopEditTableWidget.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.LoopEditTableWidget.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.LoopEditTableWidget.setVerticalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.LoopEditTableWidget.setHorizontalScrollMode(QtWidgets.QAbstractItemView.ScrollPerPixel)
        self.LoopEditTableWidget.setRowCount(1)
        self.LoopEditTableWidget.setObjectName("LoopEditTableWidget")
        self.LoopEditTableWidget.setColumnCount(2)
        item = QtWidgets.QTableWidgetItem()
        self.LoopEditTableWidget.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.LoopEditTableWidget.setHorizontalHeaderItem(1, item)
        self.LoopEditTableWidget.horizontalHeader().setCascadingSectionResizes(True)
        self.LoopEditTableWidget.horizontalHeader().setDefaultSectionSize(210)
        self.LoopEditTableWidget.horizontalHeader().setMinimumSectionSize(100)
        self.LoopEditTableWidget.horizontalHeader().setSortIndicatorShown(True)
        self.LoopEditTableWidget.horizontalHeader().setStretchLastSection(True)
        self.LoopEditTableWidget.verticalHeader().setVisible(False)
        self.LoopEditTableWidget.verticalHeader().setDefaultSectionSize(30)
        self.gridLayout_18.addWidget(self.LoopEditTableWidget, 0, 1, 1, 4)
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.gridLayout_18.addItem(spacerItem1, 3, 1, 1, 1)
        self.EquipmentTemplatesStackedWidget_2.addWidget(self.EquipmentEditPage_2)
        self.verticalLayout_17.addWidget(self.EquipmentTemplatesStackedWidget_2)
        self.verticalLayout_18.addWidget(self.EquipmentGroupBox_2)
        ...
        self.gridLayout_9.addItem(spacerItem9, 0, 3, 1, 1)
        ...
        self.gridLayout_4.addItem(spacerItem10, 1, 6, 1, 1)
        ...
        self.formLayout_3.setItem(8, QtWidgets.QFormLayout.LabelRole, spacerItem12)
        ...
        spacerItem25 = QtWidgets.QSpacerItem(13, 20, QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_8.addItem(spacerItem25, 4, 1, 3, 2)
        ...
        spacerItem26 = QtWidgets.QSpacerItem(13, 47, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_8.addItem(spacerItem26, 4, 3, 4, 1)
        ...
        self.gridLayout_8.addItem(spacerItem27, 4, 5, 2, 1)
        ...
        self.EquipmentTemplatesStackedWidget_2.setCurrentIndex(0)
    ...
    def retranslateUi(self, FinalCifWindow):
        ...
        self.EquipmentGroupBox_2.setTitle(_translate("FinalCifWindow", "Loop Templates"))
        self.LoopTemplatesListWidget.setToolTip(_translate("FinalCifWindow", "<html><head/><body><p>Each entry can have a list of key/value pairs. For example a Diffractometer model can have a list of features.</p></body></html>"))
        self.NewLoopTemplateButton.setText(_translate("FinalCifWindow", "New Template"))
        self.EditLoopTemplateButton.setText(_translate("FinalCifWindow", "Edit Template"))
        self.ImportLoopTemplateButton.setText(_translate("FinalCifWindow", "Import"))
        self.DeleteLoopButton.setText(_translate("FinalCifWindow", "Delete Template"))
        self.SaveLoopButton.setText(_translate("FinalCifWindow", "Save"))
        self.CancelLoopButton.setText(_translate("FinalCifWindow", "Cancel"))
        self.ExportLoopButton.setText(_translate("FinalCifWindow", "Export"))
        self.LoopEditTableWidget.setSortingEnabled(True)
        item = self.LoopEditTableWidget.horizontalHeaderItem(0)
        item.setText(_translate("FinalCifWindow", "key"))
        item = self.LoopEditTableWidget.horizontalHeaderItem(1)
        item.setText(_translate("FinalCifWindow", "value"))
...
"The data source will be ignored until next program restart."))
        ...
        self.LoopsTabWidget.setTabText(self.LoopsTabWidget.indexOf(self.tab), _translate("FinalCifWindow", "Loops"))
