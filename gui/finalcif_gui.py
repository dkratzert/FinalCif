...
"}")
        ...
        self.TemplatesListWidget.setSelectionRectVisible(True)
        ...
        self.formLayout_5.setWidget(4, QtWidgets.QFormLayout.SpanningRole, self.groupBox_6)
        self.label = QtWidgets.QLabel(self.groupBox_5)
        self.label.setTextFormat(QtCore.Qt.RichText)
        self.label.setOpenExternalLinks(True)
        self.label.setTextInteractionFlags(QtCore.Qt.TextBrowserInteraction)
        self.label.setObjectName("label")
        self.formLayout_5.setWidget(5, QtWidgets.QFormLayout.SpanningRole, self.label)
...
"The data source will be ignored until next program restart."))
        ...
        self.groupBox_6.setTitle(_translate("FinalCifWindow", "Report Templates (select a template to activate it)"))
