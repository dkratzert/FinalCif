...
"}")
        ...
        self.gridLayout_12.addWidget(self.groupBox_7, 2, 0, 1, 3)
        ...
        self.gridLayout_13.addItem(spacerItem24, 2, 2, 1, 1)
        ...
        self.gridLayout_8.addItem(spacerItem31, 4, 1, 3, 2)
        ...
        self.gridLayout_8.addItem(spacerItem32, 4, 3, 4, 1)
        ...
        self.gridLayout_8.addItem(spacerItem33, 4, 5, 2, 1)
        ...
        self.frame_2 = QtWidgets.QFrame(self.page_cod)
        ...
        self.personalDepositRadioButton = QtWidgets.QRadioButton(self.frame_2)
        self.personalDepositRadioButton.setObjectName("personalDepositRadioButton")
        self.horizontalLayout_9.addWidget(self.personalDepositRadioButton)
        self.prepublicationDepositRadioButton = QtWidgets.QRadioButton(self.frame_2)
        self.prepublicationDepositRadioButton.setObjectName("prepublicationDepositRadioButton")
        self.horizontalLayout_9.addWidget(self.prepublicationDepositRadioButton)
        self.publishedDepositionRadioButton = QtWidgets.QRadioButton(self.frame_2)
        self.publishedDepositionRadioButton.setObjectName("publishedDepositionRadioButton")
        self.horizontalLayout_9.addWidget(self.publishedDepositionRadioButton)
        ...
        self.verticalLayout_29 = QtWidgets.QVBoxLayout(self.page_prepublication)
        self.verticalLayout_29.setContentsMargins(0, -1, 0, -1)
        self.verticalLayout_29.setObjectName("verticalLayout_29")
        self.gridLayout_21 = QtWidgets.QGridLayout()
        self.gridLayout_21.setObjectName("gridLayout_21")
        self.depositorsFullNameLabel = QtWidgets.QLabel(self.page_prepublication)
        self.depositorsFullNameLabel.setObjectName("depositorsFullNameLabel")
        self.gridLayout_21.addWidget(self.depositorsFullNameLabel, 0, 0, 1, 1)
        ...
        self.gridLayout_21.addWidget(self.journalNameLineEdit, 2, 1, 1, 1)
        ...
        self.gridLayout_21.addWidget(self.embargoTimeInMonthsSpinBox, 3, 1, 1, 1)
        self.depsoitorEMailAddressLineEdit = QtWidgets.QLineEdit(self.page_prepublication)
        self.depsoitorEMailAddressLineEdit.setObjectName("depsoitorEMailAddressLineEdit")
        self.gridLayout_21.addWidget(self.depsoitorEMailAddressLineEdit, 1, 1, 1, 1)
        self.depsoitorEMailAddressLabel = QtWidgets.QLabel(self.page_prepublication)
        self.depsoitorEMailAddressLabel.setObjectName("depsoitorEMailAddressLabel")
        self.gridLayout_21.addWidget(self.depsoitorEMailAddressLabel, 1, 0, 1, 1)
        spacerItem39 = QtWidgets.QSpacerItem(80, 20, QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_21.addItem(spacerItem39, 2, 2, 1, 1)
        self.label_8 = QtWidgets.QLabel(self.page_prepublication)
        self.label_8.setObjectName("label_8")
        self.gridLayout_21.addWidget(self.label_8, 3, 2, 1, 1)
        self.depositorsFullNameLineEdit = QtWidgets.QLineEdit(self.page_prepublication)
        self.depositorsFullNameLineEdit.setObjectName("depositorsFullNameLineEdit")
        self.gridLayout_21.addWidget(self.depositorsFullNameLineEdit, 0, 1, 1, 1)
        self.journalMameLabel = QtWidgets.QLabel(self.page_prepublication)
        self.journalMameLabel.setObjectName("journalMameLabel")
        self.gridLayout_21.addWidget(self.journalMameLabel, 2, 0, 1, 1)
        ...
        self.gridLayout_21.addWidget(self.embargoTimeInMonthsLabel, 3, 0, 1, 1)
        self.verticalLayout_29.addLayout(self.gridLayout_21)
        ...
        self.replaceDepositCheckBox = QtWidgets.QCheckBox(self.page_published)
        self.replaceDepositCheckBox.setObjectName("replaceDepositCheckBox")
        self.verticalLayout_27.addWidget(self.replaceDepositCheckBox)
        ...
        self.gridLayout_23.addItem(spacerItem41, 1, 2, 1, 1)
        self.authorsFullNamePersonalLabel_2 = QtWidgets.QLabel(self.page_published)
        self.authorsFullNamePersonalLabel_2.setObjectName("authorsFullNamePersonalLabel_2")
        self.gridLayout_23.addWidget(self.authorsFullNamePersonalLabel_2, 1, 0, 1, 1)
        self.ContactAuthorsFullNamePersonalLineEdit_2 = QtWidgets.QLineEdit(self.page_published)
        self.ContactAuthorsFullNamePersonalLineEdit_2.setObjectName("ContactAuthorsFullNamePersonalLineEdit_2")
        self.gridLayout_23.addWidget(self.ContactAuthorsFullNamePersonalLineEdit_2, 1, 1, 1, 1)
        self.ContactAuthorEmailAddressLineEdit_2 = QtWidgets.QLineEdit(self.page_published)
        self.ContactAuthorEmailAddressLineEdit_2.setObjectName("ContactAuthorEmailAddressLineEdit_2")
        self.gridLayout_23.addWidget(self.ContactAuthorEmailAddressLineEdit_2, 2, 1, 1, 1)
        self.emailAddressToContactTheAuthorLabel_2 = QtWidgets.QLabel(self.page_published)
        self.emailAddressToContactTheAuthorLabel_2.setObjectName("emailAddressToContactTheAuthorLabel_2")
        self.gridLayout_23.addWidget(self.emailAddressToContactTheAuthorLabel_2, 2, 0, 1, 1)
        self.cod_database_code_LineEdit = QtWidgets.QLineEdit(self.page_published)
        self.cod_database_code_LineEdit.setObjectName("cod_database_code_LineEdit")
        self.gridLayout_23.addWidget(self.cod_database_code_LineEdit, 0, 1, 1, 1)
        ...
        self.gridLayout_23.addWidget(self.cod_database_code_Label, 0, 0, 1, 1)
        self.verticalLayout_27.addLayout(self.gridLayout_23)
        self.verticalLayout_26 = QtWidgets.QVBoxLayout()
        self.verticalLayout_26.setObjectName("verticalLayout_26")
        self.logMessageChangesLabel = QtWidgets.QLabel(self.page_published)
        self.logMessageChangesLabel.setObjectName("logMessageChangesLabel")
        self.verticalLayout_26.addWidget(self.logMessageChangesLabel)
        self.publishedLogPlainTextEdit = QtWidgets.QPlainTextEdit(self.page_published)
        self.publishedLogPlainTextEdit.setObjectName("publishedLogPlainTextEdit")
        self.verticalLayout_26.addWidget(self.publishedLogPlainTextEdit)
        ...
        self.label_7 = QtWidgets.QLabel(self.page_deposition_output)
        ...
        self.gridLayout_19.addWidget(self.depositHKLcheckBox, 3, 1, 1, 1)
        ...
        FinalCifWindow.setTabOrder(self.AddressTextedit, self.depsoitorEMailAddressLineEdit)
        FinalCifWindow.setTabOrder(self.depsoitorEMailAddressLineEdit, self.FootNoteLineEdit)
        ...
        FinalCifWindow.setTabOrder(self.depositorPasswordLineEdit, self.depositHKLcheckBox)
        FinalCifWindow.setTabOrder(self.depositHKLcheckBox, self.replaceDepositCheckBox)
        FinalCifWindow.setTabOrder(self.replaceDepositCheckBox, self.publishedLogPlainTextEdit)
        FinalCifWindow.setTabOrder(self.publishedLogPlainTextEdit, self.depositorsFullNameLineEdit)
...
"please add a publication author:"))
        ...
        self.depositorsFullNameLabel.setText(_translate("FinalCifWindow", "Contact authors full name (_publ_author_name)"))
        self.depsoitorEMailAddressLabel.setText(_translate("FinalCifWindow", "Email address to contact the depositor"))
        ...
        self.replaceDepositCheckBox.setText(_translate("FinalCifWindow", "Replace existing structure in the database (needs _cod_database_code)"))
        self.authorsFullNamePersonalLabel_2.setText(_translate("FinalCifWindow", "Contact authors full name (_publ_author_name)"))
        self.emailAddressToContactTheAuthorLabel_2.setText(_translate("FinalCifWindow", "Email address to contact the depositor"))
        self.cod_database_code_Label.setText(_translate("FinalCifWindow", "_cod_database_code"))
        self.logMessageChangesLabel.setText(_translate("FinalCifWindow", "Log message describing the performed changes (mandatory):"))
        self.label_7.setText(_translate("FinalCifWindow", "Deposition Output:"))
        ...
        self.depositHKLcheckBox.setText(_translate("FinalCifWindow", "deposit hkl data"))
