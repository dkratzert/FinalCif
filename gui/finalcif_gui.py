...
"}")
        ...
        self.embargoTimeInMonthsLineEdit = QtWidgets.QLineEdit(self.page_prepublication)
        self.embargoTimeInMonthsLineEdit.setObjectName("embargoTimeInMonthsLineEdit")
        self.gridLayout_21.addWidget(self.embargoTimeInMonthsLineEdit, 3, 1, 1, 1)
        ...
        self.depositorPasswordLineEdit.setEchoMode(QtWidgets.QLineEdit.PasswordEchoOnEdit)
        ...
        self.gridLayout_19.addWidget(self.depositHKLcheckBox, 2, 1, 1, 1)
        ...
        self.gridLayout_19.addWidget(self.label_2, 0, 2, 3, 1)
        ...
        FinalCifWindow.setTabOrder(self.publishedLogPlainTextEdit, self.embargoTimeInMonthsLineEdit)
        FinalCifWindow.setTabOrder(self.embargoTimeInMonthsLineEdit, self.depositorsFullNameLineEdit)
...
"The data source will be ignored until next program restart."))
        ...
        self.label_8.setText(_translate("FinalCifWindow", "default is 6 Months"))
        self.replaceDepositCheckBox.setText(_translate("FinalCifWindow", "Replace existing structure in the database"))
        ...
        self.label_2.setText(_translate("FinalCifWindow", "<html><head/><body><p>You need to have a COD account <br/>in order to deposit a cif file. </p><p><a href=\"http://crystallography.net/cod/\"><span style=\" text-decoration: underline; color:#094fd1;\">Signup here to do so</span></a></p></body></html>"))
