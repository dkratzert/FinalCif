...
"}")
        ...
        self.Author_VerticalLayout = QtWidgets.QVBoxLayout(self.tab)
        self.Author_VerticalLayout.setObjectName("Author_VerticalLayout")
...
"The data source will be ignored until next program restart."))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab), _translate("FinalCifWindow", "Author 1"))
