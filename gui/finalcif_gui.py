...
"}")
        ...
        self.InfobarHLayout.setContentsMargins(-1, 0, -1, -1)
        ...
        self.InfobarHLayout.addWidget(self.spacegroupLabel)
        ...
        self.InfobarHLayout.addWidget(self.LoopsPushButton)
        ...
        self.CifTableGridLayout.addWidget(self.MainStackedWidget, 4, 0, 1, 3)
    ...
    def retranslateUi(self, FinalCifWindow):
        ...
        self.ImportCifPushButton.setText(_translate("FinalCifWindow", "Import .cif, .pcf files"))
