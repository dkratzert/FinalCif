...
class Ui_FinalCifWindow(object):
    def setupUi(self, FinalCifWindow):
        ...
        self.gridLayout.addWidget(self.CifDataItemsGroupBox, 0, 2, 8, 1)
        ...
        self.gridLayout.addWidget(self.PropertiesGroupBox, 7, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.MercuryPushButton, 1, 1, 1, 1, QtCore.Qt.AlignRight)
        ...
        FinalCifWindow.setTabOrder(self.SelectCif_PushButton, self.DeleteEquipmentButton)
        ...
        FinalCifWindow.setTabOrder(self.CancelEquipmentButton, self.DeletePropertiesButton)
        ...
        FinalCifWindow.setTabOrder(self.CancelPropertiesButton, self.SaveCifButton)
        ...
        FinalCifWindow.setTabOrder(self.EditEquipmentTemplateButton, self.SaveResidualsTableButton)
        FinalCifWindow.setTabOrder(self.SaveResidualsTableButton, self.SaveFullReportButton)
