...
"}")
        ...
        self.verticalLayout_23.addWidget(self.AddThisAuthorPushButton)
        ...
        FinalCifWindow.setTabOrder(self.PhoneLineEdit, self.AddThisAuthorPushButton)
        FinalCifWindow.setTabOrder(self.AddThisAuthorPushButton, self.EditEquipmentTemplateButton)
