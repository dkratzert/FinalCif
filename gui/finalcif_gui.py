...
"}")
        ...
        self.formLayout_4.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.CheckCIFServerURLTextedit)
        self.gridLayout_12.addWidget(self.groupBox_7, 3, 0, 1, 3)
        ...
        self._2.addWidget(self.PictureWidthLabel)
        ...
        self._2.addWidget(self.PictureWidthDoubleSpinBox)
        ...
        self.verticalLayout_2.addWidget(self.ReportTextCheckBox)
        self.HAtomsCheckBox = QtWidgets.QCheckBox(self.groupBox_5)
        self.HAtomsCheckBox.setObjectName("HAtomsCheckBox")
        self.verticalLayout_2.addWidget(self.HAtomsCheckBox)
        ...
        self.AtomCoordsTableCheckbox = QtWidgets.QCheckBox(self.groupBox_5)
        self.AtomCoordsTableCheckbox.setObjectName("AtomCoordsTableCheckbox")
        self.verticalLayout_2.addWidget(self.AtomCoordsTableCheckbox)
        self.BondsAnglesTableCheckbox = QtWidgets.QCheckBox(self.groupBox_5)
        self.BondsAnglesTableCheckbox.setObjectName("BondsAnglesTableCheckbox")
        self.verticalLayout_2.addWidget(self.BondsAnglesTableCheckbox)
        self.TorsionTableCheckBox = QtWidgets.QCheckBox(self.groupBox_5)
        self.TorsionTableCheckBox.setObjectName("TorsionTableCheckBox")
        self.verticalLayout_2.addWidget(self.TorsionTableCheckBox)
        self.HydrogenBondTableCheckbox = QtWidgets.QCheckBox(self.groupBox_5)
        self.HydrogenBondTableCheckbox.setObjectName("HydrogenBondTableCheckbox")
        self.verticalLayout_2.addWidget(self.HydrogenBondTableCheckbox)
        self.gridLayout_12.addWidget(self.groupBox_5, 2, 0, 1, 3)
        ...
        self.gridLayout_16.addItem(spacerItem20, 0, 1, 1, 1)
        ...
        self.gridLayout_8.addItem(spacerItem21, 4, 1, 3, 2)
        ...
        spacerItem22 = QtWidgets.QSpacerItem(13, 47, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_8.addItem(spacerItem22, 4, 3, 4, 1)
        ...
        spacerItem23 = QtWidgets.QSpacerItem(225, 47, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.gridLayout_8.addItem(spacerItem23, 4, 5, 2, 1)
...
"The data source will be ignored until next program restart."))
        ...
        self.AtomCoordsTableCheckbox.setText(_translate("FinalCifWindow", "No atom coordinates table"))
        self.BondsAnglesTableCheckbox.setText(_translate("FinalCifWindow", "No bonds and angles table"))
        self.TorsionTableCheckBox.setText(_translate("FinalCifWindow", "No torsion angles table"))
        self.HydrogenBondTableCheckbox.setText(_translate("FinalCifWindow", "No hydrogen bonds table"))
