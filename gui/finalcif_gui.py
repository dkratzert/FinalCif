...
"}")
        ...
        self.depositionOptionsStackedWidget.setCurrentIndex(2)
...
"The data source will be ignored until next program restart."))
        ...
        self.personalDepositCheckBox.setText(_translate("FinalCifWindow", "personal (private)"))
        self.prepublicationDepositCheckBox.setText(_translate("FinalCifWindow", "prepublication"))
        self.publishedDepositionCheckBox.setText(_translate("FinalCifWindow", "published"))
        self.emailAddressToContactTheAuthorLabel.setText(_translate("FinalCifWindow", "Email address to contact the depositor"))
        self.authorsFullNamePersonalLabel.setText(_translate("FinalCifWindow", "Contact authors full name (as in CIF)"))
